...
import time
import numpy as np
from train import agent_backup_filename_template, burgers_env_name, burgers_fixed_set_env_name, get_env_hparams, get_paths, load, make_env
...
def test(env_name, path, use_backup, env_hparams, n_trajectories, fps, render_mode):
    ...
    ppo_hparams_path = 'models/burgers/unet_test/hparams.pkl'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--env_name', type=str, help='environment name', default=burgers_fixed_set_env_name, choices=[burgers_fixed_set_env_name, burgers_env_name])
